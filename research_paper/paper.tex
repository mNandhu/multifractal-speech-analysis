...
Before feature extraction, the speech recordings are analysed in both the time and time–frequency domains. Figure~\ref{fig:waveform_spectrogram} illustrates example waveform signals and their corresponding log-Mel spectrograms for several pathologies and healthy speech samples.

\begin{figure*}[htbp]
\centering
\includegraphics[width=0.9\linewidth, height=0.9\linewidth]{figures/waveform_spectrogram_examples.png}
\caption{Example waveform signals (left) and corresponding log-Mel spectrograms (right) for different voice conditions in the Saarbrücken Voice Database. The plots illustrate visible differences in temporal stability, harmonic structure, and spectral energy distribution between healthy speech and pathological voices.}
\label{fig:waveform_spectrogram}
\end{figure*}
